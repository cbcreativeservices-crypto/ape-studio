...
**Index version:** v33 (CANDIDATE) · **Date:** 2026-07-11 (SCHEMA v2.13 commercial mapping layer deployed to prod [additive; item-D held] + Path B files registered) · **Supersedes:** `PROJECT_FILE_INDEX_2026_07_10_v32.md` (v32)
> ⚠️ **Header note:** the v31 header line erroneously still read "v30 · 2026-06-27"; corrected here. Pointers this version: STATE **r31** (`PROJECT_STATE_CURRENT_2026_07_11_v44_r31.md`) / TRACKER **r30** (`PROGRESS_TRACKER_2026_07_11_r30.md`) / STARTUP to refresh on approval.
...
## 0.0 WHAT CHANGED SINCE INDEX v32 (this version, v33) — SCHEMA v2.13 COMMERCIAL MAPPING LAYER DEPLOYED [CANDIDATE]
