...
| **Installed app name** — `Pro Audio Training Academy` (owner 2026-09-06: never abbreviated) | `app.json` `expo.name` (native config) | ✅ | n/a | **needs the next build** — the home-screen name changes only with a new binary |
