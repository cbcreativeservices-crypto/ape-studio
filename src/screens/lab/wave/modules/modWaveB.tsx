...
export function CoverageModule(p: WaveModuleProps) {
  ...
  return (
    <WaveLayout
      ...
      check={<CheckQuestion spec={COVERAGE_CHECK} />}
    />
  );
}
...
export function LineArrayModule(p: WaveModuleProps) {
  ...
  return (
    <WaveLayout
      ...
      check={<CheckQuestion spec={LINEARRAY_CHECK} />}
    />
  );
}
...
export function DelayAlignModule(p: WaveModuleProps) {
  ...
  return (
    <WaveLayout
      ...
      check={<CheckQuestion spec={ALIGN_CHECK} />}
    />
  );
}
...
export function CardioidSubModule(p: WaveModuleProps) {
  ...
  return (
    <WaveLayout
      ...
      check={<CheckQuestion spec={CSUB_CHECK} />}
    />
  );
}
...
export function BeamSteerModule(p: WaveModuleProps) {
  ...
  return (
    <WaveLayout
      ...
      check={<CheckQuestion spec={STEER_CHECK} />}
    />
  );
}
...
export function EchoModule(p: WaveModuleProps) {
  ...
  return (
    <WaveLayout
      ...
      check={<CheckQuestion spec={ECHO_CHECK} />}
    />
  );
}
...
export function ReverbModule(p: WaveModuleProps) {
  ...
  return (
    <WaveLayout
      ...
      check={<CheckQuestion spec={REVERB_CHECK} />}
    />
  );
}
