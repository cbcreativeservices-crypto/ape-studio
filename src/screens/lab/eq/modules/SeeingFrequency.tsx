        ...
        {chartW > 0 && (
          <Svg width={chartW} height={chartH}>
            <Defs>
              ...
              <LinearGradient id="eqSpecFill" x1="0" y1={ZERO_Y} x2="0" y2={floorY} gradientUnits="userSpaceOnUse">
            ...
            {hpfPath != null && (
              <Path d={hpfPath} stroke={CURVE_AMBER} strokeWidth={2} fill="none" strokeOpacity={0.9} />
            )}
          </Svg>
        )}
