...
const styles = StyleSheet.create({
  ...
  opText: { fontFamily: fonts.oswaldMedium, fontSize: 10, letterSpacing: 0.5 },
  ...
  ratio: { color: colors.textSecondary, fontFamily: fonts.barlowMedium, fontSize: 11.5 },
  cents: { color: colors.textMuted, fontFamily: fonts.barlowRegular, fontSize: 10 },
});
