  ...
  return (
    <Text style={style}>
      {segs.map((s, i) => {
        ...
        // Outside the glossary (labs, flashcards, etc.) a glossary term is ONE
        // blue definition link — no blue/purple calculator split (owner
        // 2026-08-17: the dual-role split belongs to the glossary screen alone).
        return (
