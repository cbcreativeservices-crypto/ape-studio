...
> = {
  ...
  dashboard: {
    ...
    body:
      ...
      'Swipe the topic card to change topics, or use the rotary dial to spin directly to any topic in your deck. Tap the topic card to open its expanded view — press and hold to list every term inside it.',
