...
export const TOOL_LESSONS: Record<ToolId, LessonContent> = {
  ...
  spl: {
    ...
    controls: [
      ...
      { key: 'range', name: 'Range (VU 0-VU reference)', definition: 'The environmental sound level (in dB) that parks the VU needle at 0 VU. Set it to your room’s ambient/monitoring level and the needle then swings to show how far the signal sits above or below that reference — this keeps the VU on-scale and moving instead of pinned. AUTO tracks the ambient level automatically so the needle stays centred; the numbers 20–120 set it manually. It is a relative reference, honest regardless of calibration; it is NOT a calibrated SPL reading.' },
