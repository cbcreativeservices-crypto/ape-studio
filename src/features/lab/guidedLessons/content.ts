...
export const LAB_LESSONS: Record<LabId, LabLesson> = {
  ...
  controls: [
    ...
    { key: 'liquid_display', name: 'What the liquid display shows', definition: 'THE RIG: the apparatus from the side — lamp, dish, liquid, platform, shaker; the platform bobs at the drive frequency while the surface answers at half of it. LIQUID SURFACE: the lit, glossy surface from above. HEIGHT MAP: displacement in the Academy ramp. CONTOURS: iso-height lines. REFRACTION: the classic light-through-water caustic web. MONOCHROME: plain greyscale. 3D and CROSS-SECTION: the motion, strobed to a few hertz. All derived from one simulated field; the badge names the approximation.' },
