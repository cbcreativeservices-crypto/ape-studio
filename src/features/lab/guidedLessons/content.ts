...
export const LAB_LESSONS: Record<LabId, LabLesson> = {
  ...
  controls: [
    ...
    { key: 'art_export', name: 'Export', definition: 'PNG and transparent PNG share or save the card; SVG writes the figure as editable vector paths; PDF prints it on Letter, A4 or a square page. ART PRINT is the figure alone. LAB PRINT adds the settings block so the sheet is a lab record — it always says Simulation. Controls without a native half are disabled on this device.' },
