...
export const LAB_LESSONS: Record<LabId, LabLesson> = {
  ...
  foundations: {
    ...
    controls: [
      ...
      { key: 'domain_link', name: 'Time vs space link (M7)', definition: 'The SAME wave on two rulers: top = pressure at one point over TIME (right edge is now), bottom = pressure along the room at this INSTANT. The cursor’s two dots always sit at the same phase — the same height — because distance = speed × time ties the two axes together.' },
